...
CREATE TABLE `main_employees` (
  ...
  `payslip_password` varchar(15) DEFAULT NULL,
  `evaluation_password` varchar(15) DEFAULT NULL,
  `tax_code` varchar(15) DEFAULT NULL,
  `sss_loan`  decimal(16,2) DEFAULT 0,
  `pagibig_loan` decimal(16,2) DEFAULT 0,
  `transportation_allowance` decimal(16,2) DEFAULT 0,
  `incentive` decimal(16,2) DEFAULT 0,
  `representation_allowance` decimal(16,2) DEFAULT 0,
  `sales_incentive` decimal(16,2) DEFAULT 0,
  `tax_shield` decimal(16,2) DEFAULT 0,
  `salary_loan` decimal(16,2) DEFAULT 0,
  `development_project_engagement` decimal(16,2) DEFAULT 0,
  `general_adjustment` decimal(16,2) DEFAULT 0,
  `createdby` int(11) unsigned DEFAULT NULL,
  `modifiedby` int(11) unsigned DEFAULT NULL,
  `createddate` datetime DEFAULT NULL,
  `modifieddate` datetime DEFAULT NULL,
